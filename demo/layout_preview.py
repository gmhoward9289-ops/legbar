...
def fleet():
    return {
        "sessions": [
            ...
            {
                "source": "claude", "pid": 5, "name": "near-limit",
                "session_id": "s5", "dir": "/w/roost",
                "project": "roost", "tree": "", "branch": "",
                "task": "compact before the window fills",
                "status": "working", "context_pct": 86,
                "context_tokens": 172_000,
                "model": "claude-opus-5", "burn_tokens": 40000,
                "subagents": 0, "contested": False,
                "git": {"staged": 0, "dirty": 0, "untracked": 0,
                        "ahead": 0, "behind": 0},
                "idle_secs": 5, "worktree": "/w/roost", "git_dir": "/w/roost",
            },
            {
        ...
        "subagents": [
            {"state": "working", "agent_id": "a812a", "parent": "heron-ops-3c",
             "idle_secs": 2},
            {"state": "working", "agent_id": "b44c1", "parent": "heron-ops-3c",
             "idle_secs": 8},
            {"state": "idle", "agent_id": "c9012", "parent": "heron-ops-16",
             "idle_secs": 400},
        ],
        "warn": "",
        "gh_warn": "",
