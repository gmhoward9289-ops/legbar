...
#   curl -sL https://github.com/gmhoward9289-ops/legbar/releases/download/v0.1.0/legbar-0.1.0.tar.gz | shasum -a 256
class Legbar < Formula
  ...
  url "https://github.com/gmhoward9289-ops/legbar/releases/download/v0.1.0/legbar-0.1.0.tar.gz"
